...
//#region Exe-33 - UseContext Hook- Pass Data from Parent to Child and child to parent
...
const employeeContext =React.createContext();
function App(){
  const[employee, setEmployee] = useState({Id:109, Name:'Saqib', Location:'karachi', Salary:4000, EmploymentType:'Contract'})
...
return(<div>
  ...
  <p>
    <label>Employee Name: <b>{context.data.Salary}</b></label>
  </p>
  <button onClick={updateSalary}>Change Salary</button>
</div>);
}
